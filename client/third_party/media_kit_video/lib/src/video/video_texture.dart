                              ...
                              builder: (context, id, _) {
                                return ValueListenableBuilder<Rect?>(
                                  ...
                                  builder: (context, rect, _) {
                                    // Lumeo patch: mounted before the film
                                    // has a size, covered below instead. On
                                    // Linux the first composite of the
                                    // [Texture] is what makes mpv's renderer,
                                    // and the film is opened only after it.
